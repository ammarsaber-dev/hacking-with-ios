...
extension Bundle {
    func decode<T: Codable>(_ file: String) -> T {
        /*
            1. Get the file from bundle
            2. Convert it to Data
            3. Decode that Data into a Dictionary of [String: Astronaut] (as the json data is already like that!)
        ...
        do {
            ...
            fatalError(
                "Failed to decode \(file) from bundle because of \(error.localizedDescription)"
            )
        }
    }
}
